    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          {
            "bg-primary text-primary-foreground hover:bg-blue-700 shadow-md hover:shadow-blue-600/20 active:scale-[0.98]": variant === "default",
            "bg-secondary text-secondary-foreground hover:bg-blue-600 active:scale-[0.98]": variant === "secondary",
            ...
            "text-primary underline-offset-8 hover:underline hover:text-blue-500": variant === "link",
